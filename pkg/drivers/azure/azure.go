...
import (
	...
	"github.com/stevenimle-honeywell/docker-machine-driver-azure2/pkg/drivers/azure/azureutil"
...
func (d *Driver) GetCreateFlags() []mcnflag.Flag {
	return []mcnflag.Flag{
		...
		mcnflag.BoolFlag{
			...
			Usage:  "Type of storage system to host the OS Disk for the machine (storage-account, managed-disk)",
...
func (d *Driver) Create() error {
	...
	err = c.CreateVirtualMachine(d.ResourceGroup, d.naming().VM(), d.Location, d.Size, d.ctx.AvailabilitySetID,
		...
		storage.SkuName(d.StorageType), d.ctx.StorageAccount, d.ManagedDiskSize)
	return err
}
